    ...
    <section>
        <div className='flex flex-row items-center space-x-10'>
            <div className='flex flex-col items-start'>
                ...
                <span className='text-2xl font-bold text-black'><span className='font-bold text-neutral-800'>$</span>{userReserves?.netWorthUSD}</span>
            </div>
            <div className='flex flex-col items-start'>
            ...
            <div className='flex flex-col items-start'>
                ...
                <span className='text-2xl font-bold text-black'>{userReserves?.healthFactor}</span>
            </div>
